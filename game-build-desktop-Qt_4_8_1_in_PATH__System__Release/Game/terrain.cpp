...
#include <vector>
typedef float f;
float frustum[6][4];								//!< This field stores the information of the frustum used for culling
//! Extract the frustum
/*!
...
void terrain :: Render1(Texture a[])
{
	...
	glEnable(GL_TEXTURE_2D);
		glBindTexture(GL_TEXTURE_2D, (ad[0]).Terrainid);
		int w=(ad[0]).terrainwidth;
		int h=(ad[0]).terrainheight;
