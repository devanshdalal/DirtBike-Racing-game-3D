...
**
** Created: Mon Sep 16 12:38:54 2013
...
static const char qt_meta_stringdata_chooseLevel[] = {
    "chooseLevel\0\0on_pushButton_clicked()\0"
...
const QMetaObjectExtraData chooseLevel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject chooseLevel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_chooseLevel,
      qt_meta_data_chooseLevel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &chooseLevel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_chooseLevel))
