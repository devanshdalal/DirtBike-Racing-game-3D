...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_chooseLevel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 59, 23)
    ...
    "chooseLevel\0on_pushButton_clicked\0\0"
...
const QMetaObject chooseLevel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_chooseLevel.data,
      qt_meta_data_chooseLevel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_chooseLevel.stringdata))
